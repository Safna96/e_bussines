...
class _UploadPageState extends State<UploadPage> with AutomaticKeepAliveClientMixin<UploadPage>
{
    ...
    return Container(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            Icon(Icons.shop_two,color: Colors.black54,size: 200.0,),
            Padding(
  ...
  displayAdminUploadFormScreen()
  {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("New Plant", style: TextStyle(color: Colors.white,fontSize: 24.0, fontWeight: FontWeight.bold,),),
        actions: [
          FlatButton(
  ...
  saveItemInfo(String downloadUrl)
  {
    ...
    itemsRef.document(productId).setData({
      "shortInfo": _descriptionTextEditingController.text.trim(),
      "longDescription": _shortInfoTextEditingController.text.trim(),
