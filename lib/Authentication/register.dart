...
class _RegisterState extends State<Register>
{
          ...
          children: [
            ...
            InkWell(
              ...
              child: CircleAvatar(
                ...
                Icon(Icons.add_a_photo,size: _screenWidth *0.15,color: Colors.black,):
                    null,
              ),
            ),
            SizedBox(height: 8.0,),
  ...
  Future<void> uploadAndSaveImage() async
  {
    if(_imageFile == null)
      ...
      _passwordTextEditingController.text == _cPasswordTextEditingController.text
          ...
          :displayDialog("Please complete the requirements of the form.")
  ...
  Future saveUserInfoToFireStore(FirebaseUser fUser) async
  {
    ...
    await EcommerceApp.sharedPreferences.setString(EcommerceApp.userAvatarUrl, userImageUr);
